...
const searches = () => {
  ...
  const BookHotel = async () => {
    ...
    let transaction = await contract.bookHotel(
      hId,
      checkIn,
      checkOut,
      room2count,
    ...
    <div>
      ...
      >
        <div className="hotel-align">
          ...
          >
            <div style={{ padding: "0 10px" }}>Checkin Date:</div>
          ...
          >
            <div style={{ padding: "0 10px" }}>Checkout Date:</div>
            <div style={{ padding: "0 10px" }}>
              <input
                type="date"
                onChange={(e) => {
