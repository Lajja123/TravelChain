...
const AddHotel = () => {
  ...
  const CreateHotel = async () => {
    ...
    let transaction = await contract.createHotel(
      name,
      Address,
      Number(Pincode),
      City,
  ...
  return (
    <div className="body">
      ...
      <div className="standing-2">ADD HOTEL</div>
          ...
          <div>
            <div className="ins">
              <input
                type="number"
                className="text"
                placeholder="Room 2 person"
                onChange={(e) => {
                  fun2Person(e.target.value);
                }}
              />
            </div>
            <span className="ins">
          ...
          <div className="Room3">
            <div>
              <input
                type="number"
                className="text"
                placeholder="Room 3 person"
                onChange={(e) => {
                  fun3Person(e.target.value);
                }}
              />
            </div>
            <span>
          ...
          <div>
            <div className="ins">
              <input
                type="number"
                className="text"
                placeholder="Room 5 person"
                onChange={(e) => {
                  fun5Person(e.target.value);
                }}
              />
            </div>
            <span className="ins">
